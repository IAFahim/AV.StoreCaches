...
Efficient change tracking and caching system for optimized data access and performance.
...
```json
"com.av.storecaches": "https://github.com/IAFahim/AV.StoreCaches.git"
```

Or install via Git URL in Unity Package Manager:
1. Open Unity Package Manager (Window > Package Manager)
2. Click the + icon > Add package from git URL
3. Enter: `https://github.com/IAFahim/AV.StoreCaches.git`
...
Add components from the `AV Store Caches` package to your GameObjects via the Component menu:
`Component > AV > Store Caches > [Component Name]`

For detailed usage instructions, see the [Samples](Samples~) included with this package.

## API Documentation

For complete API reference and documentation, visit: https://github.com/IAFahim/AV.StoreCaches
...
For issues and questions, please use the [GitHub Issues](https://github.com/IAFahim/AV.StoreCaches/issues) page.
